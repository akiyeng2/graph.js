...
(function (GraphPaper) {
    var Styles = (function () {
        function Styles(stroke, fill, point, line, equation, axes, minorGridLines, majorGridLines, pointWidth, lineWidth, axisWidth) {
            ...
            if (typeof axes === "undefined") { axes = "#000000"; }
...
(function (GraphPaper) {
    ...
    var Graph = (function () {
        ...
        Graph.prototype.drawAxes = function () {
            var xAxis = new Line(new Point(this._xMin, 0), new Point(this._xMax, 0), this.style.axes, 2);
            var yAxis = new Line(new Point(0, this._yMin), new Point(0, this._yMax), this.style.axes, 2);
